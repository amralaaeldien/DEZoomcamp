...
import os
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "/Users/amrshedou/Downloads/DEZoomcamp/DEZoomcamp/terraform/Keys/mykey.json"
# Initialize a storage client
storage_client = storage.Client()
print("Storage client initialized.")
# Get your bucket
bucket = storage_client.get_bucket('module4-dezoomcamp')
print("Bucket 'dez-m4-bucket' accessed.")
